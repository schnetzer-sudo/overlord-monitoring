-- Messung M104 e - Die Probetabelle loeschen, und den Nachweis fuehren
...
SELECT COUNT(*) AS rollup_zeilen, SUM(anzahl) AS rollup_summe,
       MIN(stunde) AS von, MAX(stunde) AS bis
