-- Messung A.1 vor Schritt 10b-1 — Gegenprobe 5: der Prozessfilter · SUTTONS
...
PREPARE p_n_F0_SUTTONS_30d_prozess_gross FROM @s_nackt;
PREPARE p_h_F0_SUTTONS_30d_prozess_gross FROM @s_huelle;
SELECT '=== F0-SUTTONS-30d-prozess-gross · Plan (L15) ===' AS marke;
EXECUTE p_n_F0_SUTTONS_30d_prozess_gross;
SELECT '=== F0-SUTTONS-30d-prozess-gross · Ergebnis + Aufwaermlauf + fuenf ===' AS marke;
SELECT MAX(QUERY_ID) INTO @basis FROM information_schema.PROFILING;
EXECUTE p_h_F0_SUTTONS_30d_prozess_gross;
EXECUTE p_h_F0_SUTTONS_30d_prozess_gross;
EXECUTE p_h_F0_SUTTONS_30d_prozess_gross;
EXECUTE p_h_F0_SUTTONS_30d_prozess_gross;
EXECUTE p_h_F0_SUTTONS_30d_prozess_gross;
EXECUTE p_h_F0_SUTTONS_30d_prozess_gross;
SELECT 'F0-SUTTONS-30d-prozess-gross' AS fall,
...
DEALLOCATE PREPARE p_n_F0_SUTTONS_30d_prozess_gross;
DEALLOCATE PREPARE p_h_F0_SUTTONS_30d_prozess_gross;

-- ==========================================================================
-- F4-SUTTONS-30d-prozess-gross
-- ==========================================================================
SET @proz = @proz_gross;
SET @s_nackt = CONCAT('EXPLAIN
  SELECT m.MessageID, m.MessageLastUpdate, m.MessageStatus, m.ProcessID,
...
PREPARE p_n_F4_SUTTONS_30d_prozess_gross FROM @s_nackt;
PREPARE p_h_F4_SUTTONS_30d_prozess_gross FROM @s_huelle;
SELECT '=== F4-SUTTONS-30d-prozess-gross · Plan (L15) ===' AS marke;
EXECUTE p_n_F4_SUTTONS_30d_prozess_gross;
SELECT '=== F4-SUTTONS-30d-prozess-gross · Ergebnis + Aufwaermlauf + fuenf ===' AS marke;
SELECT MAX(QUERY_ID) INTO @basis FROM information_schema.PROFILING;
EXECUTE p_h_F4_SUTTONS_30d_prozess_gross;
EXECUTE p_h_F4_SUTTONS_30d_prozess_gross;
EXECUTE p_h_F4_SUTTONS_30d_prozess_gross;
EXECUTE p_h_F4_SUTTONS_30d_prozess_gross;
EXECUTE p_h_F4_SUTTONS_30d_prozess_gross;
EXECUTE p_h_F4_SUTTONS_30d_prozess_gross;
SELECT 'F4-SUTTONS-30d-prozess-gross' AS fall,
       COUNT(*)                                       AS anzahl_laeufe,
       MAX(CASE WHEN rn = 1 THEN ms END)              AS aufwaermlauf,
       MIN(CASE WHEN rn > 1 THEN ms END)              AS beste_von_fuenf,
       GROUP_CONCAT(CASE WHEN rn > 1 THEN ms END ORDER BY rn) AS alle_fuenf
...
DEALLOCATE PREPARE p_n_F4_SUTTONS_30d_prozess_gross;
DEALLOCATE PREPARE p_h_F4_SUTTONS_30d_prozess_gross;

-- ==========================================================================
-- F0-SUTTONS-30d-prozess-klein
-- ==========================================================================
SET @proz = @proz_klein;
SET @s_nackt = CONCAT('EXPLAIN
  SELECT m.MessageID, m.MessageLastUpdate, m.MessageStatus, m.ProcessID,
...
PREPARE p_n_F0_SUTTONS_30d_prozess_klein FROM @s_nackt;
PREPARE p_h_F0_SUTTONS_30d_prozess_klein FROM @s_huelle;
SELECT '=== F0-SUTTONS-30d-prozess-klein · Plan (L15) ===' AS marke;
EXECUTE p_n_F0_SUTTONS_30d_prozess_klein;
SELECT '=== F0-SUTTONS-30d-prozess-klein · Ergebnis + Aufwaermlauf + fuenf ===' AS marke;
SELECT MAX(QUERY_ID) INTO @basis FROM information_schema.PROFILING;
EXECUTE p_h_F0_SUTTONS_30d_prozess_klein;
EXECUTE p_h_F0_SUTTONS_30d_prozess_klein;
EXECUTE p_h_F0_SUTTONS_30d_prozess_klein;
EXECUTE p_h_F0_SUTTONS_30d_prozess_klein;
EXECUTE p_h_F0_SUTTONS_30d_prozess_klein;
EXECUTE p_h_F0_SUTTONS_30d_prozess_klein;
SELECT 'F0-SUTTONS-30d-prozess-klein' AS fall,
       COUNT(*)                                       AS anzahl_laeufe,
       MAX(CASE WHEN rn = 1 THEN ms END)              AS aufwaermlauf,
       MIN(CASE WHEN rn > 1 THEN ms END)              AS beste_von_fuenf,
       GROUP_CONCAT(CASE WHEN rn > 1 THEN ms END ORDER BY rn) AS alle_fuenf
...
DEALLOCATE PREPARE p_n_F0_SUTTONS_30d_prozess_klein;
DEALLOCATE PREPARE p_h_F0_SUTTONS_30d_prozess_klein;

-- ==========================================================================
-- F4-SUTTONS-30d-prozess-klein
-- ==========================================================================
SET @proz = @proz_klein;
SET @s_nackt = CONCAT('EXPLAIN
  SELECT m.MessageID, m.MessageLastUpdate, m.MessageStatus, m.ProcessID,
...
PREPARE p_n_F4_SUTTONS_30d_prozess_klein FROM @s_nackt;
PREPARE p_h_F4_SUTTONS_30d_prozess_klein FROM @s_huelle;
SELECT '=== F4-SUTTONS-30d-prozess-klein · Plan (L15) ===' AS marke;
EXECUTE p_n_F4_SUTTONS_30d_prozess_klein;
SELECT '=== F4-SUTTONS-30d-prozess-klein · Ergebnis + Aufwaermlauf + fuenf ===' AS marke;
SELECT MAX(QUERY_ID) INTO @basis FROM information_schema.PROFILING;
EXECUTE p_h_F4_SUTTONS_30d_prozess_klein;
EXECUTE p_h_F4_SUTTONS_30d_prozess_klein;
EXECUTE p_h_F4_SUTTONS_30d_prozess_klein;
EXECUTE p_h_F4_SUTTONS_30d_prozess_klein;
EXECUTE p_h_F4_SUTTONS_30d_prozess_klein;
EXECUTE p_h_F4_SUTTONS_30d_prozess_klein;
SELECT 'F4-SUTTONS-30d-prozess-klein' AS fall,
       COUNT(*)                                       AS anzahl_laeufe,
       MAX(CASE WHEN rn = 1 THEN ms END)              AS aufwaermlauf,
       MIN(CASE WHEN rn > 1 THEN ms END)              AS beste_von_fuenf,
       GROUP_CONCAT(CASE WHEN rn > 1 THEN ms END ORDER BY rn) AS alle_fuenf
...
DEALLOCATE PREPARE p_n_F4_SUTTONS_30d_prozess_klein;
DEALLOCATE PREPARE p_h_F4_SUTTONS_30d_prozess_klein;
