-- Messung zu Schritt 10b-1, Teil C.4: DAS TOR · NEXANS
...
-- schnell entstehen.
SELECT '=== Gleichheitsprobe NEXANS: Stundenebene gegen Tagesebene ===' AS marke;
...
SELECT '=== Gleichheitsprobe NEXANS: Zeilen, die die Ebenen lesen ===' AS marke;
...
-- ==========================================================================
-- verlauf-stunde-12monate-NEXANS
-- ==========================================================================
SELECT '=== verlauf-stunde-12monate-NEXANS · Plan (L15) ===' AS marke;
...
SELECT '=== verlauf-stunde-12monate-NEXANS · Aufwaermlauf + fuenf ===' AS marke;
...
GROUP BY DATE_FORMAT(r.stunde, '%Y-%m-01'), r.message_status
ORDER BY DATE_FORMAT(r.stunde, '%Y-%m-01'), r.message_status;
SELECT 'verlauf-stunde-12monate-NEXANS' AS fall,
...
-- ==========================================================================
-- verlauf-tag-12monate-NEXANS
-- ==========================================================================
SELECT '=== verlauf-tag-12monate-NEXANS · Plan (L15) ===' AS marke;
...
SELECT '=== verlauf-tag-12monate-NEXANS · Aufwaermlauf + fuenf ===' AS marke;
SELECT MAX(QUERY_ID) INTO @basis FROM information_schema.PROFILING;
...
GROUP BY DATE_FORMAT(r.tag, '%Y-%m-01'), r.message_status
ORDER BY DATE_FORMAT(r.tag, '%Y-%m-01'), r.message_status;
SELECT 'verlauf-tag-12monate-NEXANS' AS fall,
       COUNT(*)                                       AS anzahl_laeufe,
       MAX(CASE WHEN rn = 1 THEN ms END)              AS aufwaermlauf,
       MIN(CASE WHEN rn > 1 THEN ms END)              AS beste_von_fuenf,
       GROUP_CONCAT(CASE WHEN rn > 1 THEN ms END ORDER BY rn) AS alle_fuenf
...
-- ==========================================================================
-- verlauf-stunde-30tage-NEXANS
-- ==========================================================================
SELECT '=== verlauf-stunde-30tage-NEXANS · Plan (L15) ===' AS marke;
...
SELECT '=== verlauf-stunde-30tage-NEXANS · Aufwaermlauf + fuenf ===' AS marke;
SELECT MAX(QUERY_ID) INTO @basis FROM information_schema.PROFILING;
...
GROUP BY DATE(r.stunde), r.message_status
ORDER BY DATE(r.stunde), r.message_status;
SELECT 'verlauf-stunde-30tage-NEXANS' AS fall,
       COUNT(*)                                       AS anzahl_laeufe,
       MAX(CASE WHEN rn = 1 THEN ms END)              AS aufwaermlauf,
       MIN(CASE WHEN rn > 1 THEN ms END)              AS beste_von_fuenf,
       GROUP_CONCAT(CASE WHEN rn > 1 THEN ms END ORDER BY rn) AS alle_fuenf
...
-- ==========================================================================
-- verlauf-tag-30tage-NEXANS
-- ==========================================================================
SELECT '=== verlauf-tag-30tage-NEXANS · Plan (L15) ===' AS marke;
...
SELECT '=== verlauf-tag-30tage-NEXANS · Aufwaermlauf + fuenf ===' AS marke;
SELECT MAX(QUERY_ID) INTO @basis FROM information_schema.PROFILING;
...
GROUP BY r.tag, r.message_status
ORDER BY r.tag, r.message_status;
SELECT 'verlauf-tag-30tage-NEXANS' AS fall,
       COUNT(*)                                       AS anzahl_laeufe,
       MAX(CASE WHEN rn = 1 THEN ms END)              AS aufwaermlauf,
       MIN(CASE WHEN rn > 1 THEN ms END)              AS beste_von_fuenf,
       GROUP_CONCAT(CASE WHEN rn > 1 THEN ms END ORDER BY rn) AS alle_fuenf
...
-- ==========================================================================
-- verteilung-stunde-12monate-NEXANS
-- ==========================================================================
SELECT '=== verteilung-stunde-12monate-NEXANS · Plan (L15) ===' AS marke;
...
SELECT '=== verteilung-stunde-12monate-NEXANS · Aufwaermlauf + fuenf ===' AS marke;
SELECT MAX(QUERY_ID) INTO @basis FROM information_schema.PROFILING;
...
SELECT 'verteilung-stunde-12monate-NEXANS' AS fall,
       COUNT(*)                                       AS anzahl_laeufe,
       MAX(CASE WHEN rn = 1 THEN ms END)              AS aufwaermlauf,
       MIN(CASE WHEN rn > 1 THEN ms END)              AS beste_von_fuenf,
       GROUP_CONCAT(CASE WHEN rn > 1 THEN ms END ORDER BY rn) AS alle_fuenf
...
-- ==========================================================================
-- verteilung-tag-12monate-NEXANS
-- ==========================================================================
SELECT '=== verteilung-tag-12monate-NEXANS · Plan (L15) ===' AS marke;
EXPLAIN SELECT COUNT(*)                                        AS partner_eimer,
       SUM(t.nachrichten)                              AS nachrichten,
       MAX(t.nachrichten)                              AS groesster_eimer,
       SUM(CASE WHEN t.partner_wert IS NULL
...
SELECT '=== verteilung-tag-12monate-NEXANS · Aufwaermlauf + fuenf ===' AS marke;
SELECT MAX(QUERY_ID) INTO @basis FROM information_schema.PROFILING;
SELECT COUNT(*)                                        AS partner_eimer,
       SUM(t.nachrichten)                              AS nachrichten,
       MAX(t.nachrichten)                              AS groesster_eimer,
...
SELECT 'verteilung-tag-12monate-NEXANS' AS fall,
       COUNT(*)                                       AS anzahl_laeufe,
       MAX(CASE WHEN rn = 1 THEN ms END)              AS aufwaermlauf,
       MIN(CASE WHEN rn > 1 THEN ms END)              AS beste_von_fuenf,
       GROUP_CONCAT(CASE WHEN rn > 1 THEN ms END ORDER BY rn) AS alle_fuenf
...
-- ==========================================================================
-- verteilung-stunde-30tage-NEXANS
-- ==========================================================================
SELECT '=== verteilung-stunde-30tage-NEXANS · Plan (L15) ===' AS marke;
EXPLAIN SELECT COUNT(*)                                        AS partner_eimer,
       SUM(t.nachrichten)                              AS nachrichten,
       MAX(t.nachrichten)                              AS groesster_eimer,
       SUM(CASE WHEN t.partner_wert IS NULL
...
SELECT '=== verteilung-stunde-30tage-NEXANS · Aufwaermlauf + fuenf ===' AS marke;
SELECT MAX(QUERY_ID) INTO @basis FROM information_schema.PROFILING;
SELECT COUNT(*)                                        AS partner_eimer,
       SUM(t.nachrichten)                              AS nachrichten,
       MAX(t.nachrichten)                              AS groesster_eimer,
...
SELECT 'verteilung-stunde-30tage-NEXANS' AS fall,
       COUNT(*)                                       AS anzahl_laeufe,
       MAX(CASE WHEN rn = 1 THEN ms END)              AS aufwaermlauf,
       MIN(CASE WHEN rn > 1 THEN ms END)              AS beste_von_fuenf,
       GROUP_CONCAT(CASE WHEN rn > 1 THEN ms END ORDER BY rn) AS alle_fuenf
...
-- ==========================================================================
-- verteilung-tag-30tage-NEXANS
-- ==========================================================================
SELECT '=== verteilung-tag-30tage-NEXANS · Plan (L15) ===' AS marke;
EXPLAIN SELECT COUNT(*)                                        AS partner_eimer,
       SUM(t.nachrichten)                              AS nachrichten,
       MAX(t.nachrichten)                              AS groesster_eimer,
       SUM(CASE WHEN t.partner_wert IS NULL
...
SELECT '=== verteilung-tag-30tage-NEXANS · Aufwaermlauf + fuenf ===' AS marke;
SELECT MAX(QUERY_ID) INTO @basis FROM information_schema.PROFILING;
SELECT COUNT(*)                                        AS partner_eimer,
       SUM(t.nachrichten)                              AS nachrichten,
       MAX(t.nachrichten)                              AS groesster_eimer,
...
SELECT 'verteilung-tag-30tage-NEXANS' AS fall,
       COUNT(*)                                       AS anzahl_laeufe,
       MAX(CASE WHEN rn = 1 THEN ms END)              AS aufwaermlauf,
       MIN(CASE WHEN rn > 1 THEN ms END)              AS beste_von_fuenf,
       GROUP_CONCAT(CASE WHEN rn > 1 THEN ms END ORDER BY rn) AS alle_fuenf
