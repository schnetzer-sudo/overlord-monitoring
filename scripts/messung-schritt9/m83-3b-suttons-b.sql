-- Messung M83-3b — Fassung B, Mandant SUTTONS (L7-Gegenprobe)
...
SELECT 'SB2-wiederholung' AS marke;
SELECT DISTINCT m.ProcessID
FROM GlassfishDB.Message        m
JOIN GlassfishDB.Process        p  ON p.ProcessID = m.ProcessID
JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = p.ProjectID
...
SELECT 'SB3-wiederholung' AS marke;
SELECT DISTINCT m.ProcessID
FROM GlassfishDB.Message        m
JOIN GlassfishDB.Process        p  ON p.ProcessID = m.ProcessID
JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = p.ProjectID
...
SELECT 'SB4-wiederholung' AS marke;
SELECT DISTINCT m.ProcessID
FROM GlassfishDB.Message        m
JOIN GlassfishDB.Process        p  ON p.ProcessID = m.ProcessID
JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = p.ProjectID
...
SELECT 'SB5-wiederholung' AS marke;
SELECT DISTINCT m.ProcessID
FROM GlassfishDB.Message        m
JOIN GlassfishDB.Process        p  ON p.ProcessID = m.ProcessID
JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = p.ProjectID
...
SELECT 'SB6-wiederholung' AS marke;
SELECT DISTINCT m.ProcessID
FROM GlassfishDB.Message        m
JOIN GlassfishDB.Process        p  ON p.ProcessID = m.ProcessID
JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = p.ProjectID
