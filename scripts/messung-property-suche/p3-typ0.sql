...
SELECT '=== Typ0 / NEXANS / MESSAGE_ID / 30T (Boesfall: haeufigster Wert im 30-Tage-Fenster) ===' AS marke;
SET max_statement_time = 60;
SELECT QUOTE(m.MessageID) INTO @w FROM GlassfishDB.Message m
   WHERE m.MessageLastUpdate >= '2025-11-30 00:00:00' AND m.MessageLastUpdate < '2025-12-30 00:00:00' AND EXISTS (SELECT 1 FROM GlassfishDB.Process pr JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = pr.ProjectID WHERE pr.ProcessID = m.ProcessID AND pm.MandantID = 'NEXANS')
   ORDER BY m.MessageLastUpdate DESC, m.MessageID DESC LIMIT 1;
...
SET @q = CONCAT(
 ...
 '`GlassfishDB`.`Message`.`Target` from `GlassfishDB`.`Message` where (`GlassfishDB`.`Message`.`MessageID` ',
 '= ', @w, ' and `GlassfishDB`.`Message`.`MessageLastUpdate` >= ''2025-11-30 00:00:00'' and ',
...
SELECT '=== Typ0 / NEXANS / MESSAGE_ID / 1J (Boesfall: haeufigster Wert im 30-Tage-Fenster) ===' AS marke;
SET max_statement_time = 60;
SELECT QUOTE(m.MessageID) INTO @w FROM GlassfishDB.Message m
   WHERE m.MessageLastUpdate >= '2025-11-30 00:00:00' AND m.MessageLastUpdate < '2025-12-30 00:00:00' AND EXISTS (SELECT 1 FROM GlassfishDB.Process pr JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = pr.ProjectID WHERE pr.ProcessID = m.ProcessID AND pm.MandantID = 'NEXANS')
   ORDER BY m.MessageLastUpdate DESC, m.MessageID DESC LIMIT 1;
...
SET @q = CONCAT(
 ...
 '`GlassfishDB`.`Message`.`SourceMessageID`, `GlassfishDB`.`Message`.`TargetMessageID`, ',
 '`GlassfishDB`.`Message`.`Target` from `GlassfishDB`.`Message` where (`GlassfishDB`.`Message`.`MessageID` ',
 '= ', @w, ' and `GlassfishDB`.`Message`.`MessageLastUpdate` >= ''2024-12-30 00:00:00'' and ',
 '`GlassfishDB`.`Message`.`MessageLastUpdate` <= ''2025-12-30 00:00:00'' and exists (select 1 as `one` from ',
 '`GlassfishDB`.`Process` as `mandanten_process` join `GlassfishDB`.`ProjectMandant` on ',
 '`GlassfishDB`.`ProjectMandant`.`ProjectID` = `mandanten_process`.`ProjectID` where ',
 '(`mandanten_process`.`ProcessID` = `GlassfishDB`.`Message`.`ProcessID` and ',
...
SELECT '=== Typ0 / NEXANS / MESSAGE_ID_SOURCE / 30T (Boesfall: haeufigster Wert im 30-Tage-Fenster) ===' AS marke;
SET max_statement_time = 60;
SELECT QUOTE(s) INTO @w FROM (
  SELECT m.SourceMessageID AS s, COUNT(*) AS c FROM GlassfishDB.Message m
   WHERE m.MessageLastUpdate >= '2025-11-30 00:00:00' AND m.MessageLastUpdate < '2025-12-30 00:00:00' AND EXISTS (SELECT 1 FROM GlassfishDB.Process pr JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = pr.ProjectID WHERE pr.ProcessID = m.ProcessID AND pm.MandantID = 'NEXANS') AND m.SourceMessageID IS NOT NULL
   GROUP BY m.SourceMessageID ORDER BY c DESC, s ASC LIMIT 1) x;
SELECT CHAR_LENGTH(@w) - 2 AS laengeDesPruefwerts_w;
SET max_statement_time = 10;
SET @q = CONCAT(
 'SELECT COUNT(*) AS zeilen, MAX(CHAR_LENGTH(ProcessName)) AS maxPnLaenge FROM (select ',
 ...
 '`GlassfishDB`.`Message`.`SOSID`, `GlassfishDB`.`Message`.`SOSActionID`, `GlassfishDB`.`Message`.`Source`, ',
 '`GlassfishDB`.`Message`.`SourceMessageID`, `GlassfishDB`.`Message`.`TargetMessageID`, ',
 '`GlassfishDB`.`Message`.`Target` from `GlassfishDB`.`Message` where ',
 '(`GlassfishDB`.`Message`.`SourceMessageID` = ', @w, ' and `GlassfishDB`.`Message`.`MessageLastUpdate` >= ',
 '''2025-11-30 00:00:00'' and `GlassfishDB`.`Message`.`MessageLastUpdate` <= ''2025-12-30 00:00:00'' and ',
 'exists (select 1 as `one` from `GlassfishDB`.`Process` as `mandanten_process` join ',
 '`GlassfishDB`.`ProjectMandant` on `GlassfishDB`.`ProjectMandant`.`ProjectID` = ',
 '`mandanten_process`.`ProjectID` where (`mandanten_process`.`ProcessID` = ',
 '`GlassfishDB`.`Message`.`ProcessID` and `GlassfishDB`.`ProjectMandant`.`MandantID` = ''NEXANS''))) group ',
 'by `GlassfishDB`.`Message`.`MessageID` order by `GlassfishDB`.`Message`.`MessageLastUpdate` desc, ',
 '`GlassfishDB`.`Message`.`MessageID` desc fetch next 51 rows only) as `treffer` left outer join ',
 '`GlassfishDB`.`Process` on `GlassfishDB`.`Process`.`ProcessID` = `treffer`.`ProcessID` left outer join ',
 '`GlassfishDB`.`Project` on `GlassfishDB`.`Project`.`ProjectID` = `GlassfishDB`.`Process`.`ProjectID` left ',
 'outer join `GlassfishDB`.`SOS` on `GlassfishDB`.`SOS`.`SOSID` = `treffer`.`SOSID` left outer join ',
 '`GlassfishDB`.`SOSAction` on (`GlassfishDB`.`SOSAction`.`SOSID` = `treffer`.`SOSID` and ',
 '`GlassfishDB`.`SOSAction`.`SOSActionID` = `treffer`.`SOSActionID`) order by `treffer`.`MessageLastUpdate` ',
 'desc, `treffer`.`MessageID` desc) AS gebaut ');
SET @e = CONCAT('EXPLAIN ', @q);
...
SELECT '=== Typ0 / NEXANS / MESSAGE_ID_SOURCE / 1J (Boesfall: haeufigster Wert im 30-Tage-Fenster) ===' AS marke;
SET max_statement_time = 60;
SELECT QUOTE(s) INTO @w FROM (
  SELECT m.SourceMessageID AS s, COUNT(*) AS c FROM GlassfishDB.Message m
   WHERE m.MessageLastUpdate >= '2025-11-30 00:00:00' AND m.MessageLastUpdate < '2025-12-30 00:00:00' AND EXISTS (SELECT 1 FROM GlassfishDB.Process pr JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = pr.ProjectID WHERE pr.ProcessID = m.ProcessID AND pm.MandantID = 'NEXANS') AND m.SourceMessageID IS NOT NULL
...
SET @q = CONCAT(
 ...
 '`GlassfishDB`.`Message`.`Target` from `GlassfishDB`.`Message` where ',
 '(`GlassfishDB`.`Message`.`SourceMessageID` = ', @w, ' and `GlassfishDB`.`Message`.`MessageLastUpdate` >= ',
 '''2024-12-30 00:00:00'' and `GlassfishDB`.`Message`.`MessageLastUpdate` <= ''2025-12-30 00:00:00'' and ',
 'exists (select 1 as `one` from `GlassfishDB`.`Process` as `mandanten_process` join ',
 '`GlassfishDB`.`ProjectMandant` on `GlassfishDB`.`ProjectMandant`.`ProjectID` = ',
 '`mandanten_process`.`ProjectID` where (`mandanten_process`.`ProcessID` = ',
 '`GlassfishDB`.`Message`.`ProcessID` and `GlassfishDB`.`ProjectMandant`.`MandantID` = ''NEXANS''))) group ',
...
SELECT '=== Typ0 / NEXANS / MESSAGE_ID_TARGET / 30T (Boesfall: haeufigster Wert im 30-Tage-Fenster) ===' AS marke;
SET max_statement_time = 60;
SELECT QUOTE(s) INTO @w FROM (
  SELECT m.TargetMessageID AS s, COUNT(*) AS c FROM GlassfishDB.Message m
   WHERE m.MessageLastUpdate >= '2025-11-30 00:00:00' AND m.MessageLastUpdate < '2025-12-30 00:00:00' AND EXISTS (SELECT 1 FROM GlassfishDB.Process pr JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = pr.ProjectID WHERE pr.ProcessID = m.ProcessID AND pm.MandantID = 'NEXANS') AND m.TargetMessageID IS NOT NULL
   GROUP BY m.TargetMessageID ORDER BY c DESC, s ASC LIMIT 1) x;
SELECT CHAR_LENGTH(@w) - 2 AS laengeDesPruefwerts_w;
SET max_statement_time = 10;
SET @q = CONCAT(
 'SELECT COUNT(*) AS zeilen, MAX(CHAR_LENGTH(ProcessName)) AS maxPnLaenge FROM (select ',
 ...
 '`GlassfishDB`.`Message`.`SourceMessageID`, `GlassfishDB`.`Message`.`TargetMessageID`, ',
 '`GlassfishDB`.`Message`.`Target` from `GlassfishDB`.`Message` where ',
 '(`GlassfishDB`.`Message`.`TargetMessageID` = ', @w, ' and `GlassfishDB`.`Message`.`MessageLastUpdate` >= ',
 '''2025-11-30 00:00:00'' and `GlassfishDB`.`Message`.`MessageLastUpdate` <= ''2025-12-30 00:00:00'' and ',
 'exists (select 1 as `one` from `GlassfishDB`.`Process` as `mandanten_process` join ',
 '`GlassfishDB`.`ProjectMandant` on `GlassfishDB`.`ProjectMandant`.`ProjectID` = ',
 '`mandanten_process`.`ProjectID` where (`mandanten_process`.`ProcessID` = ',
...
SELECT '=== Typ0 / NEXANS / MESSAGE_ID_TARGET / 1J (Boesfall: haeufigster Wert im 30-Tage-Fenster) ===' AS marke;
SET max_statement_time = 60;
SELECT QUOTE(s) INTO @w FROM (
  SELECT m.TargetMessageID AS s, COUNT(*) AS c FROM GlassfishDB.Message m
   WHERE m.MessageLastUpdate >= '2025-11-30 00:00:00' AND m.MessageLastUpdate < '2025-12-30 00:00:00' AND EXISTS (SELECT 1 FROM GlassfishDB.Process pr JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = pr.ProjectID WHERE pr.ProcessID = m.ProcessID AND pm.MandantID = 'NEXANS') AND m.TargetMessageID IS NOT NULL
...
SELECT '=== Typ0 / NEXANS / PROCESS_ID / 30T (Boesfall: haeufigster Wert im 30-Tage-Fenster) ===' AS marke;
SET max_statement_time = 60;
SELECT QUOTE(s) INTO @w FROM (
...
SET @q = CONCAT(
 ...
 '`GlassfishDB`.`Message`.`SOSID`, `GlassfishDB`.`Message`.`SOSActionID`, `GlassfishDB`.`Message`.`Source`, ',
 '`GlassfishDB`.`Message`.`SourceMessageID`, `GlassfishDB`.`Message`.`TargetMessageID`, ',
 '`GlassfishDB`.`Message`.`Target` from `GlassfishDB`.`Message` where (`GlassfishDB`.`Message`.`ProcessID` ',
 '= ', @w, ' and `GlassfishDB`.`Message`.`MessageLastUpdate` >= ''2025-11-30 00:00:00'' and ',
 '`GlassfishDB`.`Message`.`MessageLastUpdate` <= ''2025-12-30 00:00:00'' and exists (select 1 as `one` from ',
 '`GlassfishDB`.`Process` as `mandanten_process` join `GlassfishDB`.`ProjectMandant` on ',
 '`GlassfishDB`.`ProjectMandant`.`ProjectID` = `mandanten_process`.`ProjectID` where ',
...
SELECT '=== Typ0 / NEXANS / PROCESS_ID / 1J (Boesfall: haeufigster Wert im 30-Tage-Fenster) ===' AS marke;
SET max_statement_time = 60;
SELECT QUOTE(s) INTO @w FROM (
  SELECT m.ProcessID AS s, COUNT(*) AS c FROM GlassfishDB.Message m
   WHERE m.MessageLastUpdate >= '2025-11-30 00:00:00' AND m.MessageLastUpdate < '2025-12-30 00:00:00' AND EXISTS (SELECT 1 FROM GlassfishDB.Process pr JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = pr.ProjectID WHERE pr.ProcessID = m.ProcessID AND pm.MandantID = 'NEXANS')
...
SELECT '=== Typ0 / NEXANS / PROCESS_NAME / 30T (Boesfall: haeufigster Wert im 30-Tage-Fenster) ===' AS marke;
SET max_statement_time = 60;
...
SET @q = CONCAT(
 ...
 '`GlassfishDB`.`Message`.`SOSID`, `GlassfishDB`.`Message`.`SOSActionID`, `GlassfishDB`.`Message`.`Source`, ',
 '`GlassfishDB`.`Message`.`SourceMessageID`, `GlassfishDB`.`Message`.`TargetMessageID`, ',
 '`GlassfishDB`.`Message`.`Target` from `GlassfishDB`.`Message` join `GlassfishDB`.`Process` as ',
 '`feld_process` on `feld_process`.`ProcessID` = `GlassfishDB`.`Message`.`ProcessID` where ',
 '(`feld_process`.`ProcessName` = ', @w, ' and `GlassfishDB`.`Message`.`MessageLastUpdate` >= ''2025-11-30 ',
 '00:00:00'' and `GlassfishDB`.`Message`.`MessageLastUpdate` <= ''2025-12-30 00:00:00'' and exists (select ',
 '1 as `one` from `GlassfishDB`.`Process` as `mandanten_process` join `GlassfishDB`.`ProjectMandant` on ',
 '`GlassfishDB`.`ProjectMandant`.`ProjectID` = `mandanten_process`.`ProjectID` where ',
 '(`mandanten_process`.`ProcessID` = `GlassfishDB`.`Message`.`ProcessID` and ',
 '`GlassfishDB`.`ProjectMandant`.`MandantID` = ''NEXANS''))) group by `GlassfishDB`.`Message`.`MessageID` ',
 'order by `GlassfishDB`.`Message`.`MessageLastUpdate` desc, `GlassfishDB`.`Message`.`MessageID` desc fetch ',
...
SELECT '=== Typ0 / NEXANS / PROCESS_NAME / 1J (Boesfall: haeufigster Wert im 30-Tage-Fenster) ===' AS marke;
SET max_statement_time = 60;
SELECT QUOTE(pn.ProcessName) INTO @w FROM (
  SELECT m.ProcessID AS s, COUNT(*) AS c FROM GlassfishDB.Message m
   WHERE m.MessageLastUpdate >= '2025-11-30 00:00:00' AND m.MessageLastUpdate < '2025-12-30 00:00:00' AND EXISTS (SELECT 1 FROM GlassfishDB.Process pr JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = pr.ProjectID WHERE pr.ProcessID = m.ProcessID AND pm.MandantID = 'NEXANS')
...
SET @q = CONCAT(
 ...
 '`GlassfishDB`.`Message`.`Target` from `GlassfishDB`.`Message` join `GlassfishDB`.`Process` as ',
 '`feld_process` on `feld_process`.`ProcessID` = `GlassfishDB`.`Message`.`ProcessID` where ',
 '(`feld_process`.`ProcessName` = ', @w, ' and `GlassfishDB`.`Message`.`MessageLastUpdate` >= ''2024-12-30 ',
 '00:00:00'' and `GlassfishDB`.`Message`.`MessageLastUpdate` <= ''2025-12-30 00:00:00'' and exists (select ',
 '1 as `one` from `GlassfishDB`.`Process` as `mandanten_process` join `GlassfishDB`.`ProjectMandant` on ',
 '`GlassfishDB`.`ProjectMandant`.`ProjectID` = `mandanten_process`.`ProjectID` where ',
 '(`mandanten_process`.`ProcessID` = `GlassfishDB`.`Message`.`ProcessID` and ',
...
SELECT '=== Typ0 / NEXANS / SOS_ID / 30T (Boesfall: haeufigster Wert im 30-Tage-Fenster) ===' AS marke;
SET max_statement_time = 60;
SELECT QUOTE(s) INTO @w FROM (
  SELECT m.SOSID AS s, COUNT(*) AS c FROM GlassfishDB.Message m
   WHERE m.MessageLastUpdate >= '2025-11-30 00:00:00' AND m.MessageLastUpdate < '2025-12-30 00:00:00' AND EXISTS (SELECT 1 FROM GlassfishDB.Process pr JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = pr.ProjectID WHERE pr.ProcessID = m.ProcessID AND pm.MandantID = 'NEXANS') AND m.SOSID IS NOT NULL
   GROUP BY m.SOSID ORDER BY c DESC, s ASC LIMIT 1) x;
SELECT CHAR_LENGTH(@w) - 2 AS laengeDesPruefwerts_w;
SET max_statement_time = 10;
SET @q = CONCAT(
 'SELECT COUNT(*) AS zeilen, MAX(CHAR_LENGTH(ProcessName)) AS maxPnLaenge FROM (select ',
 ...
 '`GlassfishDB`.`Message`.`SOSID`, `GlassfishDB`.`Message`.`SOSActionID`, `GlassfishDB`.`Message`.`Source`, ',
 '`GlassfishDB`.`Message`.`SourceMessageID`, `GlassfishDB`.`Message`.`TargetMessageID`, ',
 '`GlassfishDB`.`Message`.`Target` from `GlassfishDB`.`Message` where (`GlassfishDB`.`Message`.`SOSID` = ',
 '', @w, ' and `GlassfishDB`.`Message`.`MessageLastUpdate` >= ''2025-11-30 00:00:00'' and ',
 '`GlassfishDB`.`Message`.`MessageLastUpdate` <= ''2025-12-30 00:00:00'' and exists (select 1 as `one` from ',
 '`GlassfishDB`.`Process` as `mandanten_process` join `GlassfishDB`.`ProjectMandant` on ',
 '`GlassfishDB`.`ProjectMandant`.`ProjectID` = `mandanten_process`.`ProjectID` where ',
...
SELECT '=== Typ0 / NEXANS / SOS_ID / 1J (Boesfall: haeufigster Wert im 30-Tage-Fenster) ===' AS marke;
SET max_statement_time = 60;
SELECT QUOTE(s) INTO @w FROM (
  SELECT m.SOSID AS s, COUNT(*) AS c FROM GlassfishDB.Message m
   WHERE m.MessageLastUpdate >= '2025-11-30 00:00:00' AND m.MessageLastUpdate < '2025-12-30 00:00:00' AND EXISTS (SELECT 1 FROM GlassfishDB.Process pr JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = pr.ProjectID WHERE pr.ProcessID = m.ProcessID AND pm.MandantID = 'NEXANS') AND m.SOSID IS NOT NULL
...
SELECT '=== Typ0 / NEXANS / SOS_NAME / 30T (Boesfall: haeufigster Wert im 30-Tage-Fenster) ===' AS marke;
SET max_statement_time = 60;
SELECT QUOTE(sn.SOSName) INTO @w FROM (
  SELECT m.SOSID AS s, COUNT(*) AS c FROM GlassfishDB.Message m
   WHERE m.MessageLastUpdate >= '2025-11-30 00:00:00' AND m.MessageLastUpdate < '2025-12-30 00:00:00' AND EXISTS (SELECT 1 FROM GlassfishDB.Process pr JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = pr.ProjectID WHERE pr.ProcessID = m.ProcessID AND pm.MandantID = 'NEXANS') AND m.SOSID IS NOT NULL
   GROUP BY m.SOSID ORDER BY c DESC, s ASC LIMIT 1) x
  JOIN GlassfishDB.SOS sn ON sn.SOSID = x.s;
SELECT CHAR_LENGTH(@w) - 2 AS laengeDesPruefwerts_w;
SET max_statement_time = 10;
SET @q = CONCAT(
 'SELECT COUNT(*) AS zeilen, MAX(CHAR_LENGTH(ProcessName)) AS maxPnLaenge FROM (select ',
 ...
 '`GlassfishDB`.`Message`.`SOSID`, `GlassfishDB`.`Message`.`SOSActionID`, `GlassfishDB`.`Message`.`Source`, ',
 '`GlassfishDB`.`Message`.`SourceMessageID`, `GlassfishDB`.`Message`.`TargetMessageID`, ',
 '`GlassfishDB`.`Message`.`Target` from `GlassfishDB`.`Message` join `GlassfishDB`.`SOS` as `feld_sos` on ',
 '`feld_sos`.`SOSID` = `GlassfishDB`.`Message`.`SOSID` where (`feld_sos`.`SOSName` = ', @w, ' and ',
...
SELECT '=== Typ0 / NEXANS / SOS_NAME / 1J (Boesfall: haeufigster Wert im 30-Tage-Fenster) ===' AS marke;
SET max_statement_time = 60;
SELECT QUOTE(sn.SOSName) INTO @w FROM (
  SELECT m.SOSID AS s, COUNT(*) AS c FROM GlassfishDB.Message m
   WHERE m.MessageLastUpdate >= '2025-11-30 00:00:00' AND m.MessageLastUpdate < '2025-12-30 00:00:00' AND EXISTS (SELECT 1 FROM GlassfishDB.Process pr JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = pr.ProjectID WHERE pr.ProcessID = m.ProcessID AND pm.MandantID = 'NEXANS') AND m.SOSID IS NOT NULL
...
SELECT '=== Typ0 / NEXANS / STATUS / 30T (Boesfall: haeufigster Wert im 30-Tage-Fenster) ===' AS marke;
SET max_statement_time = 60;
SELECT QUOTE(s) INTO @w FROM (
  SELECT m.MessageStatus AS s, COUNT(*) AS c FROM GlassfishDB.Message m
   WHERE m.MessageLastUpdate >= '2025-11-30 00:00:00' AND m.MessageLastUpdate < '2025-12-30 00:00:00' AND EXISTS (SELECT 1 FROM GlassfishDB.Process pr JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = pr.ProjectID WHERE pr.ProcessID = m.ProcessID AND pm.MandantID = 'NEXANS')
   GROUP BY m.MessageStatus ORDER BY c DESC, s ASC LIMIT 1) x;
SELECT CHAR_LENGTH(@w) - 2 AS laengeDesPruefwerts_w;
SET max_statement_time = 10;
SET @q = CONCAT(
 'SELECT COUNT(*) AS zeilen, MAX(CHAR_LENGTH(ProcessName)) AS maxPnLaenge FROM (select ',
 ...
 '`GlassfishDB`.`Message`.`SourceMessageID`, `GlassfishDB`.`Message`.`TargetMessageID`, ',
 '`GlassfishDB`.`Message`.`Target` from `GlassfishDB`.`Message` where ',
 '(`GlassfishDB`.`Message`.`MessageStatus` = ', @w, ' and `GlassfishDB`.`Message`.`MessageLastUpdate` >= ',
 '''2025-11-30 00:00:00'' and `GlassfishDB`.`Message`.`MessageLastUpdate` <= ''2025-12-30 00:00:00'' and ',
 'exists (select 1 as `one` from `GlassfishDB`.`Process` as `mandanten_process` join ',
 '`GlassfishDB`.`ProjectMandant` on `GlassfishDB`.`ProjectMandant`.`ProjectID` = ',
 '`mandanten_process`.`ProjectID` where (`mandanten_process`.`ProcessID` = ',
...
SELECT '=== Typ0 / NEXANS / STATUS / 1J (Boesfall: haeufigster Wert im 30-Tage-Fenster) ===' AS marke;
SET max_statement_time = 60;
SELECT QUOTE(s) INTO @w FROM (
  SELECT m.MessageStatus AS s, COUNT(*) AS c FROM GlassfishDB.Message m
   WHERE m.MessageLastUpdate >= '2025-11-30 00:00:00' AND m.MessageLastUpdate < '2025-12-30 00:00:00' AND EXISTS (SELECT 1 FROM GlassfishDB.Process pr JOIN GlassfishDB.ProjectMandant pm ON pm.ProjectID = pr.ProjectID WHERE pr.ProcessID = m.ProcessID AND pm.MandantID = 'NEXANS')
