-- L4-Pfad-Runde - Sitzung B5: M171 - Struktur gegen Hinweis. Teuerste vollendete Kombination aus
-- M168 (Message.SNDPRN, 30 T, Fassung B 6.997 ms) und die teuerste ueberhaupt (90 T: Abbruch bei
-- B und C). Vier Erzwingungsformen: strukturell materialisiert (B), strukturell bindend (C),
-- STRAIGHT_JOIN (Fassung A mit Message zuerst), FORCE INDEX (PRIMARY) auf MessageProperty (A).
-- Beide Mandanten; bei SUTTONS ueber Message.GUID (M162). Hinweisformen sind Diagnose, keine
-- Bauempfehlung. Ablauf wie B2. Grenze 10 s. --force.
SELECT @@global.read_only AS globalReadOnly;
SET max_statement_time = 10;
SET profiling = 1;
SET profiling_history_size = 100;
SELECT '=== M171 / NEXANS / Message.SNDPRN / 30T / B materialisiert ===' AS marke;
...
SELECT '=== M171 / NEXANS / Message.SNDPRN / 30T / C bindend ===' AS marke;
SELECT QUOTE(v) INTO @w FROM (
  SELECT p.MessagePropertyValue AS v, COUNT(*) AS c
    FROM GlassfishDB.Message m
    JOIN GlassfishDB.MessageProperty p
...
SELECT '=== M171 / NEXANS / Message.SNDPRN / 30T / STRAIGHT_JOIN ===' AS marke;
SELECT QUOTE(v) INTO @w FROM (
  SELECT p.MessagePropertyValue AS v, COUNT(*) AS c
    FROM GlassfishDB.Message m
    JOIN GlassfishDB.MessageProperty p
...
SET @q = CONCAT(
 'SELECT COUNT(*) AS zeilen, MAX(CHAR_LENGTH(p2.ProcessName)) AS maxPnLaenge, ',
 '       MAX(CHAR_LENGTH(prj.ProjectName)) AS maxPjLaenge ',
 'FROM (SELECT STRAIGHT_JOIN m.MessageID, m.MessageLastUpdate, m.MessageStatus, m.ProcessID ',
 '        FROM GlassfishDB.Message m ',
 '        JOIN GlassfishDB.MessageProperty mp ON mp.MessageID = m.MessageID ',
...
SELECT '=== M171 / NEXANS / Message.SNDPRN / 30T / FORCE INDEX PRIMARY ===' AS marke;
SELECT QUOTE(v) INTO @w FROM (
  SELECT p.MessagePropertyValue AS v, COUNT(*) AS c
    FROM GlassfishDB.Message m
    JOIN GlassfishDB.MessageProperty p
...
SET @q = CONCAT(
 ...
 '       MAX(CHAR_LENGTH(prj.ProjectName)) AS maxPjLaenge ',
 'FROM (SELECT m.MessageID, m.MessageLastUpdate, m.MessageStatus, m.ProcessID ',
 '        FROM GlassfishDB.MessageProperty mp FORCE INDEX (PRIMARY) ',
...
SELECT '=== M171 / SUTTONS / Message.GUID / 30T / B materialisiert ===' AS marke;
SELECT QUOTE(v) INTO @w FROM (
  SELECT p.MessagePropertyValue AS v, COUNT(*) AS c
    FROM GlassfishDB.Message m
    JOIN GlassfishDB.MessageProperty p
...
SELECT '=== M171 / SUTTONS / Message.GUID / 30T / C bindend ===' AS marke;
SELECT QUOTE(v) INTO @w FROM (
  SELECT p.MessagePropertyValue AS v, COUNT(*) AS c
    FROM GlassfishDB.Message m
    JOIN GlassfishDB.MessageProperty p
...
SELECT '=== M171 / SUTTONS / Message.GUID / 30T / STRAIGHT_JOIN ===' AS marke;
SELECT QUOTE(v) INTO @w FROM (
  SELECT p.MessagePropertyValue AS v, COUNT(*) AS c
    FROM GlassfishDB.Message m
    JOIN GlassfishDB.MessageProperty p
...
SELECT '=== M171 / SUTTONS / Message.GUID / 30T / FORCE INDEX PRIMARY ===' AS marke;
SELECT QUOTE(v) INTO @w FROM (
  SELECT p.MessagePropertyValue AS v, COUNT(*) AS c
    FROM GlassfishDB.Message m
    JOIN GlassfishDB.MessageProperty p
...
SELECT '=== M171 / NEXANS / Message.SNDPRN / 90T / B materialisiert ===' AS marke;
SELECT QUOTE(v) INTO @w FROM (
  SELECT p.MessagePropertyValue AS v, COUNT(*) AS c
    FROM GlassfishDB.Message m
    JOIN GlassfishDB.MessageProperty p
...
SELECT '=== M171 / NEXANS / Message.SNDPRN / 90T / C bindend ===' AS marke;
SELECT QUOTE(v) INTO @w FROM (
  SELECT p.MessagePropertyValue AS v, COUNT(*) AS c
    FROM GlassfishDB.Message m
    JOIN GlassfishDB.MessageProperty p
...
SELECT '=== M171 / NEXANS / Message.SNDPRN / 90T / STRAIGHT_JOIN ===' AS marke;
SELECT QUOTE(v) INTO @w FROM (
  SELECT p.MessagePropertyValue AS v, COUNT(*) AS c
    FROM GlassfishDB.Message m
    JOIN GlassfishDB.MessageProperty p
...
SELECT '=== M171 / NEXANS / Message.SNDPRN / 90T / FORCE INDEX PRIMARY ===' AS marke;
SELECT QUOTE(v) INTO @w FROM (
  SELECT p.MessagePropertyValue AS v, COUNT(*) AS c
    FROM GlassfishDB.Message m
    JOIN GlassfishDB.MessageProperty p
...
SELECT '=== M171 / SUTTONS / Message.GUID / 90T / B materialisiert ===' AS marke;
SELECT QUOTE(v) INTO @w FROM (
  SELECT p.MessagePropertyValue AS v, COUNT(*) AS c
    FROM GlassfishDB.Message m
    JOIN GlassfishDB.MessageProperty p
...
SELECT '=== M171 / SUTTONS / Message.GUID / 90T / C bindend ===' AS marke;
SELECT QUOTE(v) INTO @w FROM (
  SELECT p.MessagePropertyValue AS v, COUNT(*) AS c
    FROM GlassfishDB.Message m
    JOIN GlassfishDB.MessageProperty p
...
SELECT '=== M171 / SUTTONS / Message.GUID / 90T / STRAIGHT_JOIN ===' AS marke;
SELECT QUOTE(v) INTO @w FROM (
  SELECT p.MessagePropertyValue AS v, COUNT(*) AS c
    FROM GlassfishDB.Message m
    JOIN GlassfishDB.MessageProperty p
...
SELECT '=== M171 / SUTTONS / Message.GUID / 90T / FORCE INDEX PRIMARY ===' AS marke;
SELECT QUOTE(v) INTO @w FROM (
  SELECT p.MessagePropertyValue AS v, COUNT(*) AS c
    FROM GlassfishDB.Message m
    JOIN GlassfishDB.MessageProperty p
