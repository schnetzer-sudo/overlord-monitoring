...
public class Keys {
    ...
    public static final UniqueKey<MessageRollupMonatRecord> KEY_MESSAGE_ROLLUP_MONAT_PRIMARY = Internal.createUniqueKey(MessageRollupMonat.MESSAGE_ROLLUP_MONAT, DSL.name("KEY_message_rollup_monat_PRIMARY"), new TableField[] { MessageRollupMonat.MESSAGE_ROLLUP_MONAT.MONAT, MessageRollupMonat.MESSAGE_ROLLUP_MONAT.PROCESS_ID, MessageRollupMonat.MESSAGE_ROLLUP_MONAT.MESSAGE_STATUS }, true);
