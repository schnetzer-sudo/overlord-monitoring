 ...
 * @param monatszeilenGeschrieben wie viele Zeilen in {@code message_rollup_monat} stehen (Schritt
 *     10b-2). Gegenueber der Tagesebene verdichtet die Monatsebene noch einmal um Faktor 10,29:
 *     11.957 gegen 123.049 ueber den Gesamtbestand (M87, Variante 4 gegen Variante 3). <b>Auch sie
 *     steht bewusst nicht in {@code rollup_lauf.zeilen_geschrieben}</b> — Begruendung an {@link
 *     RollupZeilenzahlen}
