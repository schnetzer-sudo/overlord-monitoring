 ...
 *
 * **Die Ausnahmen sind gezählt, nicht gewachsen** — Stand 21.09.2026 sind es
 * **zweihunderteins in vierundzwanzig Dateien**. Diese Zahl wird an genau dieser Stelle geführt;
