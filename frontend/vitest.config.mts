 ...
 * **zweihundertzwei in vierundzwanzig Dateien** (bis zum 21.09.2026 zweihunderteins; der eine
 * mehr steht in `tests/suchfeld-auswahl.test.tsx`, E‑232). Diese Zahl wird an genau dieser Stelle geführt;
