...
| `--dichte-suchbereich-max` | **30 rem** (480 px) | 30 rem | **Höchstbreite** des Suchbereichs ab 768 px, seit dem 22.09.2026 (E‑232). **Gewählt und nicht gemessen**, wie die 72 rem darunter. *Gebaut mit 40 rem* — Begründung damals: Belegt die Typwahl höchstens die Hälfte des Bereichs, steht bei 40 rem die längste Belegart-Bezeichnung (17,5 rem, [`spaltenwahl.md`](spaltenwahl.md) §5.1) samt Symbol ungekürzt. **Entscheidung des Auftraggebers am selben Tag, nach der Sichtprüfung: zu groß, 75 % reichen — 30 rem.** Die Typwahl bekommt damit höchstens 15 rem; die längsten Belegarten kürzen dort, mit dem Vollwert im `title` und im zugänglichen Namen. Zwischen Mindest- und Höchstbreite wächst der Bereich in den freien Raum der Kopfzeile, nach links; kein anderes Element wird dafür schmaler. *Gesehen am 22.09.2026 (M190, [`bam-suche.md`](bam-suche.md) §28): 40 rem ab 1.600 px in jeder Dichte, 18 rem bei 768 px in `m` und `l` — und dort kürzt der Produktname auf den Pixel wie vorher, seit der Mandantenblock ab `md` nicht mehr nachgibt* |
...
> höchstens 30 rem breit (gebaut mit 40, am selben Tag auf 75 % gesetzt) und wächst dazwischen nach links in den freien Raum der Kopfzeile — er
