...
> ### ⚠️ Korrektur vom 16.09.2026, zweite Runde — „Neu laden" steht **rechts** neben dem Umschalter, ohne Wort (E‑173, E‑174)
>
> **Der Kasten darüber gilt bis auf Ort und Beschriftung.** Der Knopf steht unmittelbar **rechts**
...
| **92** | **Die gedrückte Schaltfläche des Umschalters ist mit 1,07 : 1 kaum zu sehen** (§10.5). Für ein Vorleseprogramm ist der Zustand sauber ausgezeichnet, für das Auge nicht. Es ist die Gestalt von `components/ui/toggle-group.tsx` — Generatorbereich — und die **Zeitfensterwahl der Nachrichtenliste** trägt sie seit Schritt 4 genauso. Eine Änderung ist eine Entscheidung über den gemeinsamen Baustein und gehört in einen eigenen Schritt. *Fortgeschrieben am 18.09.2026 (E‑217, [`neu-laden.md`](neu-laden.md) §2):* **Der Schalter „Auto“ ist nicht mehr betroffen** — er trug seit dem 16.09.2026 dieselbe gedrückte Fläche und trägt eingeschaltet jetzt die Akzentfläche, per `className` an der Aufrufstelle, der Generatorbereich ist unberührt. **Für den Zeitraumumschalter bleibt der Punkt unverändert offen** |
