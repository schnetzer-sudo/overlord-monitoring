...
Messgrundlage: [`messungen-schritt9.md`](messungen-schritt9.md), M74 bis M79
...
> laut §3.2 technische Mandanten und keine Kunden; ob ihre acht Prozesse überhaupt kuratiert werden
> sollen, ist offen (§9).
...
**E6 — Sortierung nach Projekt und Name.** Das im Plantext vorgesehene Aufkommen der letzten 30 Tage
entfällt: Es wäre eine Live-Aggregation über `Message` (Leistungsregel 2), von
...
> **Korrektur an §4.4.** Dort ist die Massenzuordnung nach Projekt als Hebel für den **Partner**
> benannt. Gemessen greift sie für den Partner bei VOTG und für die **Richtung** bei NEXANS. *Der
> Hebel greift — aber nicht für das Feld, für das er dort benannt ist.*
>
...
| 2 | Sollen `WOC` (4) und `SYSTEM` (4) überhaupt kuratiert werden? Beide sind laut §3.2 technisch und keine Kunden |
| 3 | Regel A bei **zwei** Unterstrichen ist für die neun NEXANS-Prozesse dieser Gestalt nicht geprüft |
| 4 | Der Anker `Eingehend`/`Ausgehend` in Projektnamen ist für `ZAST`, `NXHBE`, `EDITIONLINGERI`, `WOC` und `SYSTEM` nicht erhoben |
